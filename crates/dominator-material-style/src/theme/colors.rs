...
impl Default for Colors {
    fn default() -> Self {
        Self {
            ...
            secondary: Color::Hex("#03a9f4".to_string()),
            secondary_dark: Color::Hex("#0276aa".to_string()),
            secondary_light: Color::Hex("#35baf6".to_string()),
            secondary_lightest: Color::Hex("#72cff8".to_string()),
